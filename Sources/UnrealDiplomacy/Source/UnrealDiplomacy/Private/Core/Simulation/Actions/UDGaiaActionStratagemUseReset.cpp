...
void UUDGaiaActionStratagemUseReset::Execute(const FUDActionData& action, TObjectPtr<UUDWorldState> world)
{
...
void UUDGaiaActionStratagemUseReset::Revert(const FUDActionData& action, TObjectPtr<UUDWorldState> world)
{
...
void UUDGaiaActionStratagemUseReset::SetResourceManager(TWeakObjectPtr<UUDResourceManager> resourceManager)
{
