...
#include "UDSettingActionStratagemOptionSelect.generated.h"

/**
 * Adds specified action as stratagem.
 */
UCLASS(Blueprintable, BlueprintType)
class UNREALDIPLOMACY_API UUDSettingActionStratagemOptionSelect : public UUDSettingAction
{
	GENERATED_BODY()
public:
...
public:
	static const int32 ActionTypeId = 4006;
};