...
#include "UDGameActionMilitarySupport.generated.h"

/**
 * Enables player to support others with his army.
 */
UCLASS(Blueprintable, BlueprintType)
class UNREALDIPLOMACY_API UUDGameActionMilitarySupport : public UUDGameAction
{
	GENERATED_BODY()
public:
...
public:
	static const int32 ActionTypeId = 2015;
protected:
	UPROPERTY()
