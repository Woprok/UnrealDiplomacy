...
#include "UDGameActionMilitarySupportCancel.generated.h"

/**
 * Cancels military support.
 */
UCLASS(Blueprintable, BlueprintType)
class UNREALDIPLOMACY_API UUDGameActionMilitarySupportCancel : public UUDGameAction
{
	GENERATED_BODY()
public:
...
public:
	static const int32 ActionTypeId = 2016;
protected:
	UPROPERTY()
