...
/**
 * Sabotages the action that is part of the contract..
 */
UCLASS(Blueprintable, BlueprintType)
class UNREALDIPLOMACY_API UUDDealActionContractPointSabotage : public UUDDealAction
{
	GENERATED_BODY()
public:
...
public:
	static const int32 ActionTypeId = 3022;
};
