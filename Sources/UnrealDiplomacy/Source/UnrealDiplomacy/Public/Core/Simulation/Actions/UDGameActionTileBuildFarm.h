...
#include "UDGameActionTileBuildFarm.generated.h"

/**
 * Invoker will build Farm on specified tile.
 */
UCLASS(Blueprintable, BlueprintType)
class UNREALDIPLOMACY_API UUDGameActionTileBuildFarm : public UUDGameAction
{
	GENERATED_BODY()
public:
...
public:
	static const int32 ActionTypeId = 2024;
protected:
	UPROPERTY()
