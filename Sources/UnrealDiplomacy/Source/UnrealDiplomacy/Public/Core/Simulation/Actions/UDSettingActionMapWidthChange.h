...
#include "UDSettingActionMapWidthChange.generated.h"

/**
 * Change final map width.
 */
UCLASS(Blueprintable, BlueprintType)
class UNREALDIPLOMACY_API UUDSettingActionMapWidthChange : public UUDSettingAction
{
	GENERATED_BODY()
public:
...
public:
	static const int32 ActionTypeId = 4003;
};